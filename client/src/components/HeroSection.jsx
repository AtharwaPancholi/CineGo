...
const HeroSection = () => {
  ...
  return (
    ...
    px-6 md:px-16 lg:px-36 bg-[url("/src/assets/backgroundImage.png")] 
    bg-cover bg-center h-screen'>
      ...
      <p className='max-w-md text-gray-300'>In a post-apocalyptic world where cities ride on wheels
        and consume each other to survive, two people meet in London and try to 
        stop a conspiracy.
      </p>
      <button onClick={()=> navigate()} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary
